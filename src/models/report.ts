...
export default class ReportModel{
    ...
    static async postNewForShop(
        ...
        if(customer==null){
            return new Response(HttpStatusCode.BAD_REQUEST, 'Customer is not exist !');
        }
        ...
        if(!(report==null)){
            ...
            return new Response(HttpStatusCode.CREATED,'Create new report successfully !',
            {
                shop: shop.name,
    ...
    static async editStatus(
        ...
        const report = await reportReposity.update({id: id},{status: StatusReportEnum.PROCESSED});
